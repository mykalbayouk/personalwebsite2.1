    ...
    >
      <div className="max-w-8xl mx-auto py-10 px-4 md:px-8 lg:px-10 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2">
          <h1 className="text-xl md:text-4xl mb-4 text-white max-w-4xl font-bold">
        About me
          </h1>
          <p className="text-white-300 dark:text-neutral-300 text-sm md:text-base max-w-sm">
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-purple-500 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
